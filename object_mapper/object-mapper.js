...
function _mapKey(fromObject, fromKey, toObject, toKey) {
    ...
    if (typeof fromValue === 'undefined' || fromValue === null || fromValue==="") {
    ...
    if (typeof fromValue !== 'undefined' && typeof transform === 'function') {
        let value = transform(fromValue, fromObject, toObject, fromKey, toKey);
        fromValue = Array.from(fromValue, v => v === undefined ? value : v);
